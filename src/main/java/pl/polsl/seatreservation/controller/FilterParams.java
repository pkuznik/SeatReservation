...
public class FilterParams {
    ...
    public FilterParams(String args[]) {
        ...
        } else if (mode == Parameters.UI_MODE_CONSOLE) {
            sizeX = input.readWidthHall();
        }
        ...
        if (mode == Parameters.UI_MODE_CONSOLE && args.length == 0) {
            args = input.readQuantityOfChairsToReserve();
        }
     ...
     * @param args Array of arguments
     * @return New array without argument and value for remove (index i and i +
     * 1)
     */
